...
import { Loader2, Clock, FileText, Sparkles, ChevronDown, ChevronUp } from "lucide-react";
...
export default function HistoryList() {
  ...
  const [expandedId, setExpandedId] = useState<string | null>(null); // Состояние для открытия/закрытия карточек
        ...
        {recordings.map((rec) => (
          <div key={rec.id} className="bg-white rounded-xl border border-gray-200 shadow-sm overflow-hidden transition-all hover:shadow-md hover:border-blue-200">
            ...
            >
              ...
              <Button variant="ghost" size="sm" className="h-8 w-8 p-0 shrink-0 text-gray-400 hover:bg-gray-100 rounded-full">
